...
public:
    StackDeque();
    void insertFront(const DataType &e);
    void insertBack(const DataType &e);
    void removeFront();
    void removeBack();
    DataType front();
    DataType back();
...
void StackDeque::insertFront(const DataType &e)
{
    while (!s1.isEmpty())
    {
        s2.push(s1.getTop());
...
void StackDeque::insertBack(const DataType &e)
{

    s1.push(e);
}
void StackDeque::removeFront()
{
    while (!s1.isEmpty())
    {
        s2.push(s1.getTop());
...
void StackDeque::removeBack()
{
    s1.pop();
}
DataType StackDeque::front()
{
    while (!s1.isEmpty())
    {
        s2.push(s1.getTop());
